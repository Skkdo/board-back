...
public interface BoardRepository extends JpaRepository<Board, Integer> {
    ...
    @Modifying
    @Query("UPDATE Board b SET b.favoriteCount = b.favoriteCount - 1 WHERE b.boardNumber = :boardNumber")
    void decreaseFavoriteCount(@Param("boardNumber") Integer boardNumber);

    @Modifying
    @Query("UPDATE Board b SET b.commentCount = b.commentCount + 1 WHERE b.boardNumber = :boardNumber")
    void increaseCommentCount(@Param("boardNumber") Integer boardNumber);

    @Modifying
    @Query("UPDATE Board b SET b.commentCount = b.commentCount - 1 WHERE b.boardNumber = :boardNumber")
    void decreaseCommentCount(@Param("boardNumber") Integer boardNumber);
