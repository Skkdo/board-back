...
public class UserServiceTest {
    ...
    void getSignInUser() {
        ...
        GetSignInUserResponseDto GetSignInUserResponseDto = userService.getSignInUser(user.getEmail());

        assertThat(GetSignInUserResponseDto.getEmail()).isEqualTo(user.getEmail());
        verify(userRepository, times(1)).findByEmail(user.getEmail());
    }
