...
import com.kjh.boardback.domain.user.controller.UserController;
...
public class UserControllerTest {
    ...
    void getSignInUser() throws Exception {
        ...
        doReturn(getUserResponseDto).when(userService).getUser(null);
    ...
    void findByEmailOrElseThrow() throws Exception {
        ...
        doThrow(exception).when(userService).getUser(null);
