...
import com.kjh.boardback.domain.board.controller.BoardFavoriteController;
...
@ActiveProfiles("test")
public class BoardFavoriteControllerTest {

    @InjectMocks
    private BoardFavoriteController boardFavoriteController;
    ...
    void build() {
        mockMvc = MockMvcBuilders
                .standaloneSetup(boardFavoriteController)
