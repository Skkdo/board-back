...
import com.kjh.boardback.controller.SearchController;
...
public class SearchControllerTest {
    ...
    void getPopularList() throws Exception {
        ...
        doReturn(getPopularListResponseDto).when(searchService).getPopularList();
    ...
    void getRelationList() throws Exception {
        ...
        doReturn(getRelationListResponseDto).when(searchService).getRelationList(pathVariable);
